...
// 登录api
const signApiUrl: Route = '/api/auth/sign-in'
...
// 注册api
const signUpApiUrl: Route = '/api/auth/sign-up'
...
// 退出登录
const signOutApiUrl: Route = '/api/auth/sign-out'
...
// 查询当前登录用户信息
const signUserApiUrl: Route = '/api/auth/sign-user'
...
// 获取验证码
const captchaApiUrl: Route = '/api/auth/captcha'
